...
const index = require("./index-XdR35-El.js");
...
const clone$1 = require("lodash/clone");
...
const has$4 = require("lodash/has");
...
const clone__default = /* @__PURE__ */ _interopDefault(clone$1);
...
const has__default = /* @__PURE__ */ _interopDefault(has$4);
...
const SettingsModal = ({ item }) => {
  ...
  const { getSettings, setSettings } = index.useSettingsApi();
  const [isOpen, setIsOpen] = React__namespace.useState(false);
  const [metaTitle, setMetaTitle] = React__namespace.useState(true);
  const [metaDescription, setMetaDescription] = React__namespace.useState(true);
  const [metaRobots, setMetaRobots] = React__namespace.useState(true);
  const [openGraph, setOpenGraph] = React__namespace.useState(true);
  const [wordCount, setWordCount] = React__namespace.useState(true);
  const [canonicalUrl, setCanonicalUrl] = React__namespace.useState(true);
  const [keywordDensity, setKeywordDensity] = React__namespace.useState(true);
  const [structuredData, setStructuredData] = React__namespace.useState(true);
  const [alternativeText, setAlternativeText] = React__namespace.useState(true);
  const [lastUpdatedAt, setLastUpdatedAt] = React__namespace.useState(true);
  const [defaultSettings, setDefaultSettings] = React__namespace.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Root, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Trigger, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "tertiary", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Cog, {}), onClick: () => setupModalSettings(), children: formatMessage({
      id: index.getTrad("SEOPage.info.config"),
      defaultMessage: "Settings"
    }) }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { labelledBy: "title", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "title", children: formatMessage({
        id: index.getTrad("SEOPage.info.settings"),
        defaultMessage: "Settings"
      }) }) }),
          ...
          children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(
                admin.ContentBox,
                {
                  ...
                  subtitle: formatMessage({
                    id: index.getTrad("HomePage.info.settings.information"),
                  ...
                  designSystem.Grid.Item,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", children: formatMessage({
                        id: index.getTrad(`SEOPage.info.settings.${id}`),
                        defaultMessage
                      }) })
                    ]
                  },
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Footer, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Close, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "tertiary", children: formatMessage({
                id: index.getTrad("SEOPage.info.settings.cancel.button"),
                defaultMessage: "Cancel"
              }) }) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { type: "submit", children: formatMessage({
                id: index.getTrad("SEOPage.info.settings.save.button"),
                defaultMessage: "Save"
              }) })
            ] })
          ]
...
const Main = ({ contentTypes }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tabs.Root, { id: "tabs", variant: "simple", defaultValue: TabValues.collectionTypes, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tabs.List, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Trigger, { value: TabValues.collectionTypes, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: formatMessage({
        id: index.getTrad("SEOPage.tab.collection-type-title"),
        defaultMessage: "Collection Types"
      }) }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Trigger, { value: TabValues.singleTypes, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", children: formatMessage({
        id: index.getTrad("SEOPage.tab.single-type-title"),
        defaultMessage: "Single Types"
      }) }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Trigger, { value: TabValues.plugins, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", children: formatMessage({
        id: index.getTrad("SEOPage.tab.plugin-title"),
        defaultMessage: "Plugins"
      }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Content, { value: TabValues.collectionTypes, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 2, rowCount: contentTypes.collectionTypes.length, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
        id: index.getTrad("SEOPage.tab-panel.column-name"),
        defaultMessage: "Name"
      }) }) }) }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: contentTypes && contentTypes.collectionTypes && Array.isArray(contentTypes.collectionTypes) && contentTypes.collectionTypes.length > 0 ? contentTypes.collectionTypes.map((item) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: item.globalId }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "right", alignItems: "right", children: item.seo ? /* @__PURE__ */ jsxRuntime.jsx(SettingsModal, { item }) : /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.LinkButton,
          {
            ...
            children: formatMessage({
              id: index.getTrad("SEOPage.info.add"),
              defaultMessage: "Add component"
            })
          }
        ) }) })
      ] }, item.uid)) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, background: "neutral0", children: /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.EmptyStateLayout,
        {
          icon: /* @__PURE__ */ jsxRuntime.jsx(index.Illo, {}),
          content: formatMessage({
            id: index.getTrad("SEOPage.info.no-collection-types"),
          ...
          action: /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.LinkButton,
            {
              ...
              startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, {}),
              children: formatMessage({
                id: index.getTrad("SEOPage.info.create-collection-type"),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Content, { value: TabValues.singleTypes, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 2, rowCount: contentTypes.singleTypes.length, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
        id: index.getTrad("SEOPage.tab-panel.column-name"),
        defaultMessage: "Name"
      }) }) }) }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: contentTypes && contentTypes.singleTypes && Array.isArray(contentTypes.singleTypes) && contentTypes.singleTypes.length > 0 ? contentTypes.singleTypes.map((item) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: item.globalId }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "right", alignItems: "right", children: item.seo ? /* @__PURE__ */ jsxRuntime.jsx(SettingsModal, { item }) : /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.LinkButton,
          {
        ...
        designSystem.EmptyStateLayout,
        {
          icon: /* @__PURE__ */ jsxRuntime.jsx(index.Illo, {}),
          content: formatMessage({
            id: index.getTrad("SEOPage.info.no-single-types"),
          ...
          action: /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.LinkButton,
            {
              ...
              startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, {}),
              children: formatMessage({
                id: index.getTrad("SEOPage.info.create-single-type"),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Content, { value: TabValues.plugins, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 2, rowCount: contentTypes.plugins.length, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tr, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: formatMessage({
        id: index.getTrad("SEOPage.tab-panel.column-name"),
        defaultMessage: "Name"
      }) }) }) }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: contentTypes && contentTypes.plugins && Array.isArray(contentTypes.plugins) && contentTypes.plugins.length > 0 ? contentTypes.plugins.map((item) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: item.globalId }) }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "right", alignItems: "right", children: item.seo ? /* @__PURE__ */ jsxRuntime.jsx(SettingsModal, { item }) : /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.LinkButton,
          {
        ...
        designSystem.EmptyStateLayout,
        {
          icon: /* @__PURE__ */ jsxRuntime.jsx(index.Illo, {}),
          content: formatMessage({
            id: index.getTrad("SEOPage.info.no-plugin-content-type"),
...
function createValidation(config) {
  function validate(_ref, cb) {
    ...
    function createError(overrides = {}) {
      const nextParams = mapValues__default.default(_extends$2({
        value,
        originalValue,
        label,
...
function sortFields(fields, excludes = []) {
  ...
  for (const key in fields)
    if (has__default.default(fields, key)) {
...
class ObjectSchema extends BaseSchema {
  ...
  transformKeys(fn2) {
    return this.transform((obj) => obj && mapKeys__default.default(obj, (_2, key) => fn2(key)));
  }
  camelCase() {
...
const useElementOnScreen = (options) => {
  ...
  const [isVisible, setIsVisible2] = React__namespace.useState(true);
...
const Header = (seoComponent) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral100", children: /* @__PURE__ */ jsxRuntime.jsx(
    Layouts.Header,
    {
      secondaryAction: seoComponent ? null : /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.LinkButton,
        {
          tag: reactRouterDom.NavLink,
          variant: "tertiary",
          ...
          children: formatMessage({
            id: index.getTrad("SEOPage.header.button.edit-component"),
            defaultMessage: "Edit SEO component"
          })
        }
      ),
      title: formatMessage({
        id: index.getTrad("SEOPage.header.title"),
        defaultMessage: "SEO"
      }),
      subtitle: formatMessage({
        id: index.getTrad("SEOPage.header.subtitle"),
...
const HomePage = React__namespace.memo(() => {
  const { get, post } = admin.useFetchClient();
  const { lockAppWithAutoreload, unlockAppWithAutoreload } = admin.private_useAutoReloadOverlayBlocker();
  const { formatMessage } = reactIntl.useIntl();
  const [isLoading, setIsLoading] = React__namespace.useState(true);
  const [shouldEffect, setShouldEffect] = React__namespace.useState(false);
  const seoComponent = React__namespace.useRef(null);
  const contentTypes = React__namespace.useRef(null);
  const fetchSeoComponent = async () => {
    try {
      const { data } = await get(`/${index.pluginId}/component`);
      return data;
    } catch (error) {
      return null;
    }
  ...
  const fetchContentTypes = async () => {
    try {
      const { data } = await get(`/${index.pluginId}/content-types`);
      return data;
    } catch (error) {
      return null;
    }
  ...
  const createSeoComponent = async () => {
    try {
      const data = await post(`/${index.pluginId}/component`);
      return data.json();
    } catch (error) {
      return null;
    }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(Header, { seoComponent: seoComponent.current }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 8, paddingRight: 8, children: /* @__PURE__ */ jsxRuntime.jsx(
      admin.ContentBox,
      {
        title: formatMessage({
          id: "Information",
        ...
        subtitle: formatMessage({
          id: index.getTrad("HomePage.info.information"),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(Main, { contentTypes: contentTypes.current })
  ] });
});
const App = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(admin.private_AutoReloadOverlayBlockerProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Protect, { permissions: index.pluginPermissions.main, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Routes, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { index: true, element: /* @__PURE__ */ jsxRuntime.jsx(HomePage, {}) }),
    /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: "*", element: /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Error, {}) })
  ] }) }) });
};
exports.default = App;
//# sourceMappingURL=index-m_BSXmEA.js.map
