...
import { useNotification, ContentBox, useFetchClient, private_useAutoReloadOverlayBlocker, Page, private_AutoReloadOverlayBlockerProvider } from "@strapi/strapi/admin";
import { useIntl } from "react-intl";
import { Modal, Button, Typography, Box, Grid, Switch, Tabs, Table, Thead, Tr, Th, Tbody, Td, Flex, LinkButton, EmptyStateLayout, Link, Alert, useCallbackRef, useComposedRefs, Field, Toggle, Checkbox, DatePicker, DateTimePicker, TextInput, SingleSelect, SingleSelectOption, JSONInput, NumberInput, Textarea, TimePicker, Popover } from "@strapi/design-system";
import { Cog, Information, Plus, ArrowLeft, Eye, EyeStriked, WarningCircle, Filter, CaretDown, Pencil } from "@strapi/icons";
import { u as useSettingsApi, g as getTrad, I as Illo, p as pluginId, a as pluginPermissions } from "./index-DoK7BakP.mjs";
...
const SettingsModal = ({ item }) => {
  ...
  return /* @__PURE__ */ jsxs(Modal.Root, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsx(Modal.Trigger, { children: /* @__PURE__ */ jsx(Button, { variant: "tertiary", startIcon: /* @__PURE__ */ jsx(Cog, {}), onClick: () => setupModalSettings(), children: formatMessage({
      id: getTrad("SEOPage.info.config"),
      defaultMessage: "Settings"
    }) }) }),
    /* @__PURE__ */ jsxs(Modal.Content, { labelledBy: "title", children: [
...
const Main = ({ contentTypes }) => {
  ...
  return /* @__PURE__ */ jsx(Box, { padding: 8, children: /* @__PURE__ */ jsxs(Tabs.Root, { id: "tabs", variant: "simple", defaultValue: TabValues.collectionTypes, children: [
    /* @__PURE__ */ jsxs(Tabs.List, { children: [
      /* @__PURE__ */ jsx(Tabs.Trigger, { value: TabValues.collectionTypes, children: /* @__PURE__ */ jsx(Typography, { children: formatMessage({
        id: getTrad("SEOPage.tab.collection-type-title"),
        defaultMessage: "Collection Types"
      }) }) }),
      /* @__PURE__ */ jsx(Tabs.Trigger, { value: TabValues.singleTypes, children: /* @__PURE__ */ jsx(Typography, { variant: "omega", children: formatMessage({
        id: getTrad("SEOPage.tab.single-type-title"),
        defaultMessage: "Single Types"
      }) }) }),
      /* @__PURE__ */ jsx(Tabs.Trigger, { value: TabValues.plugins, children: /* @__PURE__ */ jsx(Typography, { variant: "omega", children: formatMessage({
        id: getTrad("SEOPage.tab.plugin-title"),
        defaultMessage: "Plugins"
      }) }) })
    ] }),
    /* @__PURE__ */ jsx(Tabs.Content, { value: TabValues.collectionTypes, children: /* @__PURE__ */ jsxs(Table, { colCount: 2, rowCount: contentTypes.collectionTypes.length, children: [
      /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsx(Tr, { children: /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: formatMessage({
        id: getTrad("SEOPage.tab-panel.column-name"),
        defaultMessage: "Name"
      }) }) }) }) }),
      /* @__PURE__ */ jsx(Tbody, { children: contentTypes && contentTypes.collectionTypes && Array.isArray(contentTypes.collectionTypes) && contentTypes.collectionTypes.length > 0 ? contentTypes.collectionTypes.map((item) => /* @__PURE__ */ jsxs(Tr, { children: [
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: item.globalId }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Flex, { justifyContent: "right", alignItems: "right", children: item.seo ? /* @__PURE__ */ jsx(SettingsModal, { item }) : /* @__PURE__ */ jsx(
          LinkButton,
          {
      ...
      ] }, item.uid)) : /* @__PURE__ */ jsx(Box, { padding: 8, background: "neutral0", children: /* @__PURE__ */ jsx(
        EmptyStateLayout,
        {
    ...
    /* @__PURE__ */ jsx(Tabs.Content, { value: TabValues.singleTypes, children: /* @__PURE__ */ jsxs(Table, { colCount: 2, rowCount: contentTypes.singleTypes.length, children: [
      /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsx(Tr, { children: /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: formatMessage({
        id: getTrad("SEOPage.tab-panel.column-name"),
        defaultMessage: "Name"
      }) }) }) }) }),
      /* @__PURE__ */ jsx(Tbody, { children: contentTypes && contentTypes.singleTypes && Array.isArray(contentTypes.singleTypes) && contentTypes.singleTypes.length > 0 ? contentTypes.singleTypes.map((item) => /* @__PURE__ */ jsxs(Tr, { children: [
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: item.globalId }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Flex, { justifyContent: "right", alignItems: "right", children: item.seo ? /* @__PURE__ */ jsx(SettingsModal, { item }) : /* @__PURE__ */ jsx(
          LinkButton,
          {
    ...
    /* @__PURE__ */ jsx(Tabs.Content, { value: TabValues.plugins, children: /* @__PURE__ */ jsxs(Table, { colCount: 2, rowCount: contentTypes.plugins.length, children: [
      /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsx(Tr, { children: /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: formatMessage({
        id: getTrad("SEOPage.tab-panel.column-name"),
        defaultMessage: "Name"
      }) }) }) }) }),
      /* @__PURE__ */ jsx(Tbody, { children: contentTypes && contentTypes.plugins && Array.isArray(contentTypes.plugins) && contentTypes.plugins.length > 0 ? contentTypes.plugins.map((item) => /* @__PURE__ */ jsxs(Tr, { children: [
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: item.globalId }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Flex, { justifyContent: "right", alignItems: "right", children: item.seo ? /* @__PURE__ */ jsx(SettingsModal, { item }) : /* @__PURE__ */ jsx(
          LinkButton,
          {
...
function createValidation(config) {
  function validate(_ref, cb) {
    ...
    function createError(overrides = {}) {
      const nextParams = mapValues(_extends$2({
        value,
        originalValue,
        label,
...
const Header = (seoComponent) => {
  ...
  return /* @__PURE__ */ jsx(Box, { background: "neutral100", children: /* @__PURE__ */ jsx(
    Layouts.Header,
    {
      secondaryAction: seoComponent ? null : /* @__PURE__ */ jsx(
        LinkButton,
        {
          tag: NavLink,
          variant: "tertiary",
...
const HomePage = React.memo(() => {
  ...
  return /* @__PURE__ */ jsxs(React.Fragment, { children: [
    /* @__PURE__ */ jsx(Header, { seoComponent: seoComponent.current }),
    /* @__PURE__ */ jsx(Box, { paddingLeft: 8, paddingRight: 8, children: /* @__PURE__ */ jsx(
      ContentBox,
      {
        title: formatMessage({
          id: "Information",
    ...
    /* @__PURE__ */ jsx(Main, { contentTypes: contentTypes.current })
  ] });
});
const App = () => {
  return /* @__PURE__ */ jsx(private_AutoReloadOverlayBlockerProvider, { children: /* @__PURE__ */ jsx(Page.Protect, { permissions: pluginPermissions.main, children: /* @__PURE__ */ jsxs(Routes, { children: [
...
//# sourceMappingURL=index-BxZP8eN4.mjs.map
