import { Information, WarningCircle, CrossCircle, CheckCircle, Eye, ArrowRight, Search } from "@strapi/icons";
import * as React from "react";
import { jsxs, jsx, Fragment } from "react/jsx-runtime";
import { useFetchClient, unstable_useContentManagerContext, unstable_useDocument } from "@strapi/strapi/admin";
import { useIntl } from "react-intl";
import { Accordion, IconButton, Box, Typography, Flex, Status, ProgressBar, Badge, Modal, EmptyStateLayout, Divider, Button, TextButton } from "@strapi/design-system";
...
const openGraphPreview = (modifiedData) => {
  ...
  if (isNull(openGraph) || openGraph === void 0) {
    status = {
      message: "",
      qualityVerdict: qualityVerdict.bad
    };
...
const SEOAccordion = ({ title, status, component, label }) => {
  ...
  return /* @__PURE__ */ jsx(Accordion.Root, { children: /* @__PURE__ */ jsxs(Accordion.Item, { value: "acc-01", children: [
    /* @__PURE__ */ jsxs(Accordion.Header, { children: [
      /* @__PURE__ */ jsx(Accordion.Trigger, { icon: getIcon(), children: title }),
      /* @__PURE__ */ jsx(Accordion.Actions, { children: /* @__PURE__ */ jsx(IconButton, { label, children: /* @__PURE__ */ jsx(Information, {}) }) })
    ] }),
    /* @__PURE__ */ jsxs(Accordion.Content, { children: [
      /* @__PURE__ */ jsx(Box, { paddingTop: 4, paddingLeft: 4, paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "omega", children: status?.message }) }),
      component && component
    ] })
  ] }) });
};
...
const MetaRobotCheck = ({ metaRobots, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: /* @__PURE__ */ jsxs(Box, { padding: 2, background: "neutral100", children: [
        robotTags.map((tag, index2) => /* @__PURE__ */ jsxs(Flex, { spacing: 2, horizontal: true, padding: 2, children: [
          tags.find((x) => x.trim() === tag.name) ? /* @__PURE__ */ jsx(CheckCircle, { "aria-hidden": true, fill: `success600` }) : /* @__PURE__ */ jsx(WarningCircle, { "aria-hidden": true, fill: `warning600` }),
          /* @__PURE__ */ jsx(Typography, { paddingLeft: 1, children: tags.find((x) => x.trim() === tag.name) ? `${tag.name} is activated:
          ${tag.message.replace("will", "will not")}` : `${tag.name} is disabled: ${tag.message}` })
        ] }, index2)),
        /* @__PURE__ */ jsx(Flex, { spacing: 2, paddingTop: 4, paddingLeft: 2, paddingRight: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Status, { variant: "secondary", showBullet: false, children: /* @__PURE__ */ jsxs(Typography, { children: [
          /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", children: "Notice: " }),
          "In order to not index your entry and no follow, your MetaRobots field should contain the following:",
          /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", children: " noindex, nofollow " }),
...
const WordCountCheck = ({ wordCount, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: isNumber(wordCount) && /* @__PURE__ */ jsx(Box, { padding: 4, background: "neutral100", children: /* @__PURE__ */ jsxs(Typography, { variant: "omega", fontWeight: "bold", children: [
        formatMessage({
...
const MetaTitleCheck = ({ metaTitle, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: metaTitle && /* @__PURE__ */ jsxs(Box, { padding: 4, background: "neutral100", children: [
        /* @__PURE__ */ jsx(Typography, { variant: "omega", fontWeight: "semiBold", children: metaTitle }),
        /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: /* @__PURE__ */ jsxs(Flex, { horizontal: true, spacing: 2, children: [
          /* @__PURE__ */ jsx(
            ProgressBar,
            {
              size: "M",
          ...
          /* @__PURE__ */ jsxs(Typography, { variant: "pi", padding: 2, children: [
            "(",
            metaTitle.length,
            "/",
            maxLength,
...
const CanonicalUrlCheck = ({ canonicalUrl, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: /* @__PURE__ */ jsx(Box, { padding: canonicalUrl ? 4 : 0, background: "neutral100", children: canonicalUrl && /* @__PURE__ */ jsx(Typography, { variant: "omega", fontWeight: "bold", children: canonicalUrl }) })
    }
  );
};
const LastUpdatedAtCheck = ({ updatedAt, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: updatedAt && /* @__PURE__ */ jsx(Box, { padding: 4, background: "neutral100", children: /* @__PURE__ */ jsxs(Typography, { variant: "omega", children: [
        formatMessage({
        ...
        /* @__PURE__ */ jsxs(Typography, { variant: "omega", fontWeight: "bold", children: [
          " ",
          formatDistance(new Date(updatedAt), /* @__PURE__ */ new Date(), {
            addSuffix: true
          })
        ] })
      ] }) })
...
const KeywordDensityCheck = ({ keywordsDensity, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: keywordsDensity && !isEmpty(keywordsDensity) && /* @__PURE__ */ jsx(Box, { padding: 2, background: "neutral100", children: /* @__PURE__ */ jsx(Flex, { wrap: "wrap", children: Object.keys(keywordsDensity).map((keyword) => /* @__PURE__ */ jsx(Box, { padding: 2, children: /* @__PURE__ */ jsx(Badge, { children: `${keyword}:
                      ${get(keywordsDensity[keyword], "count", 0).toString()}` }) }, keyword)) }) })
    }
  );
};
...
const MetaDescriptionCheck = ({ metaDescription, checks }) => {
 ...
 For it to remain visible in Google, it must not exceed 140-${maxLength} characters.`
      ...
      component: metaDescription && /* @__PURE__ */ jsxs(Box, { padding: 4, background: "neutral100", children: [
        /* @__PURE__ */ jsx(Typography, { variant: "omega", fontWeight: "semiBold", children: metaDescription }),
        /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: /* @__PURE__ */ jsxs(Flex, { horizontal: true, spacing: 2, children: [
          /* @__PURE__ */ jsx(
            ProgressBar,
            {
...
const AlternativeTextCheck = ({ intersections, richTextAlts, altTexts, checks }) => {
  ...
  return /* @__PURE__ */ jsx(
    SEOAccordion,
    {
      ...
      component: /* @__PURE__ */ jsxs(Box, { padding: 2, background: "neutral100", children: [
        /* @__PURE__ */ jsxs(Flex, { spacing: 2, horizontal: true, padding: 2, children: [
          /* @__PURE__ */ jsx(WarningCircle, { "aria-hidden": true, fill: `warning600` }),
          /* @__PURE__ */ jsxs(Typography, { paddingLeft: 1, children: [
        ...
        richTextAlts.map((alt, index2) => /* @__PURE__ */ jsx(Flex, { spacing: 2, horizontal: true, padding: 2, children: alt.occurences > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(WarningCircle, { "aria-hidden": true, fill: `warning600` }),
          /* @__PURE__ */ jsxs(Typography, { paddingLeft: 1, children: [
            /* @__PURE__ */ jsxs(Typography, { fontWeight: "bold", children: [
              alt.occurences,
        ...
        /* @__PURE__ */ jsx(Flex, { spacing: 2, paddingTop: 4, paddingLeft: 2, paddingRight: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Status, { variant: "secondary", showBullet: false, children: /* @__PURE__ */ jsxs(Typography, { children: [
          /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", children: "Tip: " }),
          "Implement a rule in your front-end code that uses the name of your images if the",
          /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", children: " alternativeText " }),
...
const getRichTextData = (modifiedData, components, contentType) => {
  ...
  richTextFields.forEach((data) => {
    if (isNull(data.field)) {
      ...
      const components2 = get(modifiedData, data.inDz, []);
...
const SeoChecks = ({ updatedAt, modifiedData, components, contentType, checks }) => {
  ...
  return /* @__PURE__ */ jsxs(Modal.Content, { labelledBy: "title", children: [
    ...
    /* @__PURE__ */ jsx(Modal.Body, { children: hasSeo ? /* @__PURE__ */ jsxs(Box, { children: [
      checks?.metaTitle && /* @__PURE__ */ jsx(MetaTitleCheck, { metaTitle: seo?.metaTitle ?? null, checks }),
      checks?.metaDescription && /* @__PURE__ */ jsx(
      ...
      checks?.wordCount && /* @__PURE__ */ jsx(WordCountCheck, { wordCount, checks }),
      checks?.keywordsDensity && /* @__PURE__ */ jsx(KeywordDensityCheck, { keywordsDensity, checks }),
      checks?.openGraph && /* @__PURE__ */ jsx(OpenGraphCheck, { openGraph: seo?.openGraph ?? null, checks }),
      checks?.canonicalUrl && /* @__PURE__ */ jsx(CanonicalUrlCheck, { canonicalUrl: seo?.canonicalURL ?? null, checks }),
      checks?.structuredData && /* @__PURE__ */ jsx(StructuredDataCheck, { structuredData: seo?.structuredData ?? null, checks }),
      checks?.metaRobots && /* @__PURE__ */ jsx(MetaRobotCheck, { metaRobots: seo?.metaRobots ?? null, checks }),
      checks?.alternativeText && /* @__PURE__ */ jsx(
      ...
      checks?.lastUpdatedAt && /* @__PURE__ */ jsx(LastUpdatedAtCheck, { updatedAt, checks })
...
const PreviewChecks = ({ checks }) => {
  ...
  return /* @__PURE__ */ jsxs(Box, { paddingTop: 2, children: [
    /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
      /* @__PURE__ */ jsx(CheckCircle, { "aria-hidden": true, fill: `success600` }),
    ...
    /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
      /* @__PURE__ */ jsx(CrossCircle, { "aria-hidden": true, fill: `danger600` }),
      /* @__PURE__ */ jsxs(Typography, { children: [
        formatMessage({
          id: getTrad("Bad"),
          defaultMessage: "Bad"
...
const Serp = ({ metaTitle, metaDescription }) => {
  ...
  return /* @__PURE__ */ jsxs(Box, { padding: 4, background: "neutral100", width: "580px", children: [
    /* @__PURE__ */ jsx(Typography, { variant: "beta", textColor: "primary600", children: metaTitleToDisplay }),
    /* @__PURE__ */ jsx(Flex, { marginTop: 1, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: metaDescriptionToDisplay }) })
  ] });
};
const MetaChecks = ({ item, max, label, minLimit = false }) => {
  const getIcon = () => {
    if (item.length >= max || label === "title" && item.length === 0 || minLimit && label === "description" && item.length <= 50) {
      return /* @__PURE__ */ jsx(WarningCircle, { "aria-hidden": true, fill: `warning600` });
    } else {
      return /* @__PURE__ */ jsx(CheckCircle, { "aria-hidden": true, fill: `success600` });
    }
  };
  return /* @__PURE__ */ jsxs(Flex, { spacing: 1, horizontal: true, children: [
    getIcon(),
    /* @__PURE__ */ jsx(Typography, { children: `Your ${label} is ${item.length || 0} characters long (max ${max})` })
  ] });
};
const KeywordCheck = ({ item, keywords: keywords2, label }) => {
  ...
  return /* @__PURE__ */ jsxs(Flex, { spacing: 1, horizontal: true, children: [
    getIcon(),
    /* @__PURE__ */ jsx(Typography, { children: `You use ${matches.length} keyword${matches.length > 1 ? "s" : ""} in your ${label} (${matches.join(", ").trim()})` })
  ] });
};
const BrowserPreview = ({ modifiedData }) => {
  ...
  const keywords2 = get(seo, "keywords", null);
  return /* @__PURE__ */ jsxs(Modal.Content, { labelledBy: "title", children: [
    /* @__PURE__ */ jsx(Modal.Header, { children: /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "title", children: formatMessage({
      id: getTrad("Button.browser-preview"),
      defaultMessage: "Browser Preview"
    }) }) }),
    /* @__PURE__ */ jsx(Modal.Body, { children: seo ? /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, alignItems: "flex-start", children: [
      metaTitle && metaDescription && /* @__PURE__ */ jsx(Box, { paddingBottom: 6, children: /* @__PURE__ */ jsx(Serp, { metaTitle, metaDescription }) }),
      /* @__PURE__ */ jsx(Divider, { marginBottom: 4, width: "100%" }),
      metaTitle && /* @__PURE__ */ jsx(MetaChecks, { item: metaTitle, max: 60, label: "title" }),
      metaDescription && /* @__PURE__ */ jsx(MetaChecks, { item: metaDescription, max: 160, label: "description", minLimit: true }),
      keywords2 && /* @__PURE__ */ jsxs(React.Fragment, { children: [
        metaTitle && /* @__PURE__ */ jsx(KeywordCheck, { item: metaTitle, keywords: keywords2, label: "title" }),
        metaDescription && /* @__PURE__ */ jsx(KeywordCheck, { item: metaDescription, keywords: keywords2, label: "description" })
      ] })
    ] }) : /* @__PURE__ */ jsx(Box, { paddingLeft: 4, children: /* @__PURE__ */ jsx(
      EmptyStateLayout,
      {
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { style: { width: "100%", position: "relative", paddingTop: "52.5%" }, children: /* @__PURE__ */ jsx(
              "img",
              {
                src: image.url,
                alt: title,
        ...
        /* @__PURE__ */ jsxs("div", { style: { backgroundColor: "#f2f3f5", padding: "12px 10px", lineHeight: "1.4" }, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              style: {
...
const OpenGraphPreview = ({ modifiedData }) => {
  ...
  return /* @__PURE__ */ jsxs(Modal.Content, { labelledBy: "title", children: [
    ...
    /* @__PURE__ */ jsx(Modal.Body, { children: openGraph["ogTitle"] && openGraph["ogDescription"] && openGraph["ogImage"] ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(Flex, { alignItems: "left", direction: "column", gap: 2, children: /* @__PURE__ */ jsx(Flex, { gap: 1, children: /* @__PURE__ */ jsx(Badge, { backgroundColor: "neutral150", textColor: "neutral600", children: "Facebook" }) }) }),
      /* @__PURE__ */ jsx(
        FacebookOGPreview,
        {
      ...
      /* @__PURE__ */ jsx(Flex, { alignItems: "left", direction: "column", gap: 2, children: /* @__PURE__ */ jsx(Flex, { gap: 1, children: /* @__PURE__ */ jsx(Badge, { backgroundColor: "neutral150", textColor: "neutral600", children: "X (Twitter)" }) }) }),
      /* @__PURE__ */ jsx(
        TwitterOGPreview,
        {
          title: openGraph["ogTitle"],
      ...
      /* @__PURE__ */ jsx(Flex, { alignItems: "left", direction: "column", gap: 2, children: /* @__PURE__ */ jsx(Flex, { gap: 1, children: /* @__PURE__ */ jsx(Badge, { backgroundColor: "neutral150", textColor: "neutral600", children: "LinkedIn" }) }) }),
      /* @__PURE__ */ jsx(
        LinkedInOGPreview,
        {
          title: openGraph["ogTitle"],
...
const SeoCheckerContext = React.createContext(null);
const Summary = () => {
  const { formatMessage } = useIntl();
  ...
  const { model, collectionType, id, form, contentType, components } = unstable_useContentManagerContext();
  ...
  return /* @__PURE__ */ jsx(SeoCheckerContext.Provider, { value: dispatch, children: /* @__PURE__ */ jsxs(Box, { paddingTop: 4, width: "100%", children: [
    /* @__PURE__ */ jsx(Typography, { tag: "h2", variant: "sigma", textTransform: "uppercase", textColor: "neutral600", children: formatMessage({
      id: getTrad("Plugin.name"),
      defaultMessage: "SEO Plugin"
    }) }),
    metaTitle && metaDescription && /* @__PURE__ */ jsxs(Modal.Root, { children: [
      /* @__PURE__ */ jsx(Modal.Trigger, { children: /* @__PURE__ */ jsx(Box, { paddingTop: 1, children: /* @__PURE__ */ jsx(Button, { fullWidth: true, variant: "secondary", startIcon: /* @__PURE__ */ jsx(Eye, {}), children: formatMessage({
        id: getTrad("Button.browser-preview"),
        defaultMessage: "Browser Preview"
      }) }) }) }),
      /* @__PURE__ */ jsx(BrowserPreview, { modifiedData })
    ] }),
    openGraph && /* @__PURE__ */ jsxs(Modal.Root, { children: [
      /* @__PURE__ */ jsx(Modal.Trigger, { children: /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: /* @__PURE__ */ jsx(Button, { fullWidth: true, variant: "secondary", startIcon: /* @__PURE__ */ jsx(Eye, {}), children: formatMessage({
        id: getTrad("Button.open-graph-preview"),
        defaultMessage: "Open Graph Preview"
      }) }) }) }),
      /* @__PURE__ */ jsx(OpenGraphPreview, { modifiedData })
    ] }),
    !isLoading && /* @__PURE__ */ jsx(PreviewChecks, { checks }),
    /* @__PURE__ */ jsxs(Modal.Root, { children: [
      /* @__PURE__ */ jsx(Modal.Trigger, { children: /* @__PURE__ */ jsx(Box, { paddingTop: 4, children: /* @__PURE__ */ jsx(TextButton, { startIcon: /* @__PURE__ */ jsx(ArrowRight, {}), children: formatMessage({
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./index-BxZP8eN4.mjs")
    });
    app.registerPlugin({
      id: pluginId,
  ...
  async registerTrads(app) {
    ...
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-D_923Zjg.mjs"), "./translations/fr.json": () => import("./fr-4GniPx7g.mjs"), "./translations/pt-BR.json": () => import("./pt-BR-Coahg9yn.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
export {
  Illo as I,
  pluginPermissions as a,
  getTrad as g,
  index as i,
  pluginId as p,
  useSettingsApi as u
};
//# sourceMappingURL=index-DoK7BakP.mjs.map
