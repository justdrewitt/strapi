...
} from "./chunk-KHLAIOXU.js";
import {
  useTypedSelector
} from "./chunk-NXXAFURA.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-6XOBZGJM.js";
import {
  useConfig
} from "./chunk-6MTJZWXM.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-CBV6S6Q6.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-3AP75XLD.js";
import {
  pluginId
...
import {
  useLicenseLimits
} from "./chunk-I6QT7UC3.js";
import {
  Table,
  useTable
} from "./chunk-Z2YBBMB6.js";
import {
  useField,
  useForm
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/de.json":
      return import("./de.json-IAG6SM2H.js");
    case "./translations/dk.json":
      return import("./dk.json-ORMQ7KKB.js");
    case "./translations/en.json":
      return import("./en.json-F2QGZYEK.js");
    case "./translations/es.json":
      return import("./es.json-HLWMSFWG.js");
    case "./translations/fr.json":
      return import("./fr.json-VEEIIGVP.js");
    ...
    case "./translations/ko.json":
      return import("./ko.json-DODF6KQ5.js");
    ...
    case "./translations/pl.json":
      return import("./pl.json-43Q6KXCV.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-PDW6B3IZ.js");
    ...
    case "./translations/zh.json":
      return import("./zh.json-JA7AOQKT.js");
    default:
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-WPTE6ELC.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-UY3IJYLH.js").then((mod) => ({
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case "./translations/ru.json":
      return import("./ru.json-7RHQQRAN.js");
    case "./translations/sk.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-SYFYOCC6.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-737QTALZ.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-ASZM2OLN.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-OI7C3XJP.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-T3RFLD57.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-G6PNOFZH.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-LZWM7KKX.js");
          return {
...
function __variableDynamicImportRuntime2__2(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-BKR325G2.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-GFJQLCNA.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-MYTXFVPE.js");
          return {
...
//# sourceMappingURL=chunk-NZHRS3PU.js.map
