...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/ru.json":
      return import("./ru.json-BSPLLGAX.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-7LOPYUR2.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-NX4P4KVC.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-NX4P4KVC.js");
...
//# sourceMappingURL=chunk-H2MKMDMT.js.map
