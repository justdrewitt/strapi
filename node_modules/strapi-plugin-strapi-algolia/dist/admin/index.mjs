...
import { useNotification, useFetchClient, ConfirmDialog, useRBAC } from "@strapi/strapi/admin";
      ...
      Dialog.Root,
      {
        ...
        children: /* @__PURE__ */ jsx(
          ConfirmDialog,
          {
            ...
            variant: "default",
            icon: /* @__PURE__ */ jsx(WarningCircle, { fill: "danger500" }),
            children: formatMessage({
...
const ListViewInjectedComponent = () => {
  ...
  return /* @__PURE__ */ jsx(IndexAllButton, { contentType: routeMatch?.params.slug });
};
...
const index = {
  ...
  async registerTrads({ locales }) {
    const importedTranslations = await Promise.all(
      locales.map(
        (locale) => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("../_chunks/en-Ci4uzbLv.mjs"), "./translations/fr.json": () => import("../_chunks/fr-Dh10el5u.mjs") }), `./translations/${locale}.json`, 3).then(({ default: data }) => ({
